...
<header style="text-align:center; margin-top:3rem; margin-bottom:2rem;">
  ...
  <p style="color:var(--text-secondary); font-size:1.2rem; margin-top:1rem;">Elite Training Program for Modern DevSecOps</p>
</header>
    ...
    <div class="module" style="text-align:center;">
     ...
     <div class="module" style="text-align:center;">
      <h3>🐧 Linux Basics 4 </h3>
            <p>Networking and networking commands in linux</p>
      <a href="lessons/04-linux-basics/" class="btn btn-success">Start Lesson</a>
